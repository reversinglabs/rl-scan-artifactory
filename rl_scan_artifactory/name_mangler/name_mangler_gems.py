...
class NameManglerGems(
    ...
    def _mangle(
        ...
        # gem with binary tail: nokogiri-1.16.7-x86_64-linux.gem
        # gem with arch in name: middleman-core-x86-mingw32-3.0.14.gem
        remainder = self._strip_tail(file_name, ".gem")
